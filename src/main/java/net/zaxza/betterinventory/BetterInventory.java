package net.zaxza.betterinventory;
...
import net.zaxza.betterinventory.item.ModCreativeModeTabs;
import net.zaxza.betterinventory.item.ModItems;
import org.slf4j.Logger;

// The value here should match an entry in the META-INF/mods.toml file
@Mod(BetterInventory.MOD_ID)
public class BetterInventory
{
    // Define mod id in a common place for everything to reference
    public static final String MOD_ID = "betterinventory";
